                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key => $slider)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td><img src="{{(!empty($slider->image))?url('/upload/slider_image/'.$slider->image):url('/upload/no-img.png')}}" height="150px" width="300px" alt="logo"></td>
                                            ...
                                            <td>
                                                ...
                                                <a title="Delete" id="delete" href="{{ route('delete-slider',$slider->id)}}" class="btn btn-sm btn-danger">
